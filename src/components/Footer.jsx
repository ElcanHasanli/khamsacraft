      ...
      <div className="container">
        <div className={styles.footerContent}>
          <div className={styles.footerLeft}>
            <img className={styles.footerLogoImg} src={KhamsaCraftLogo} alt="KhamsaCraftLogo" />
            <p className={styles.footerTagline}>
              Yaradıcılıq və innovasiya ilə brendinizi zirvəyə çatdırırıq
            </p>
          </div>
          
          <div className={styles.footerCenter}>
            <h3 className={styles.footerHeading}>Sosial Şəbəkələr</h3>
          ...
          <div className={styles.footerRight}>
            <h3 className={styles.footerHeading}>Əlaqə</h3>
            <div className={styles.contactInfo}>
              <p className={styles.contactItem}>
                <span className={styles.contactIcon}>📧</span>
                contact@khamsacraft.az
              </p>
              <p className={styles.contactItem}>
                <span className={styles.contactIcon}>📱</span>
                +994 50 555 62 32             </p>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>© 2025 Khamsacraft. Bütün hüquqlar qorunur.</p>
        </div>
      </div>
    </footer>
  )
